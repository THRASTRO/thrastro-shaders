...
Math.pow(d.x,4),1/Math.pow(d.y,4),1/Math.pow(d.z,4));d=a.G;b.fg.value=d;b.fg2.value=d*d;d=a.Kr;var f=a.Km,m=a.ESun;b.fKrESun.value=d*m;b.fKmESun.value=f*m;b.fKr4PI.value=4*d*Math.PI;b.fKm4PI.value=4*f*Math.PI;d=a.scaleDepth;f=a.innerRadius;m=f+a.height;b.fBias.value=a.bias;b.fExposure.value=a.exposure;b.fScale.value=1/(m-f);b.fScaleDepth.value=d;b.fOuterRadius.value=m;b.fInnerRadius.value=f;b.fOuterRadius2.value=m*m;b.fInnerRadius2.value=f*f}}updateUniforms(){var a=this.uniforms;super.updateUniforms();
var b=a.fCameraPos.value;b.setFromMatrixPosition(camera.matrixWorld);this.pbody&&this.pbody.matrixWorld&&(g.copy(this.pbody.matrixWorld).invert(),b.applyMatrix4(g));b=b.lengthSq();a.fCameraHeight.value=Math.sqrt(b);a.fCameraHeight2.value=b}addUniforms(a){super.addUniforms(a);a.fg={type:"f",value:0};a.fg2={type:"f",value:0};a.fKrESun={type:"f",value:0};a.fKmESun={type:"f",value:0};a.fKr4PI={type:"f",value:0};a.fKm4PI={type:"f",value:0};a.fScale={type:"f",value:0};a.fBias={type:"f",value:0};a.fExposure=
